    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
      ...
      <div class="grid md:grid-cols-3 gap-6">
        <div class="rounded-2xl border p-6 hover:shadow-md transition">
          ...
          <p class="text-gray-600">Onboarding en días, no meses. Importación de catálogo y reglas de stock sin dolores.</p>
        </div>
        <div class="rounded-2xl border p-6 hover:shadow-md transition">
          <div class="text-indigo-600 font-bold text-sm uppercase mb-2">Decisiones con datos</div>
          <p class="text-gray-600">Reportes claros de rotación, quiebres y valorización para planificar compras con precisión.</p>
        </div>
        <div class="rounded-2xl border p-6 hover:shadow-md transition">
          <div class="text-indigo-600 font-bold text-sm uppercase mb-2">Crecimiento seguro</div>
          <p class="text-gray-600">Roles, auditoría y API para integrarte con POS, e-commerce y facturación.</p>
        </div>
      </div>
    </div>
  </section>
